...
export function childrenListToLayout(docker: HTMLElement, curX: number, spacing: number, autoDriver: boolean, driverNums: number): HTMLElement | undefined {
...
export function makeDockerItem(itemsVNode: VNode[], autoDriver: boolean, driverNums: number, controlVNode?: VNode[]) {
